...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<meta name="description" content="chart.js CDN by jsDelivr - A free, fast, and reliable Open Source CDN for npm and GitHub">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>chart.js CDN by jsDelivr - A free, fast, and reliable Open Source CDN</title>
		<style>
			body {
	...
	<body>
		<div class="container">
			<div class="header">
				<h1>chart.js CDN files</h1>

				<a class="badge" href="https://www.jsdelivr.com/package/npm/chart.js" title="jsDelivr monthly hits">
					<img alt="jsDelivr monthly hits badge" src="https://data.jsdelivr.com/v1/package/npm/chart.js/badge">
				</a>
			</div>
			...
			<div class="path">
				<ol itemscope itemtype="https://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
						<span itemprop="name">chart.js@4.5.1</span>
						<meta itemprop="position" content="0">
					</li>
				</ol>

				<select class="versions select-css">
					<option value="chart.js@4.5.1">chart.js@4.5.1</option>
					<option value="chart.js@4.5.0">chart.js@4.5.0</option>
					<option value="chart.js@4.4.9">chart.js@4.4.9</option>
					<option value="chart.js@4.4.8">chart.js@4.4.8</option>
					<option value="chart.js@4.4.7">chart.js@4.4.7</option>
					<option value="chart.js@4.4.6">chart.js@4.4.6</option>
					<option value="chart.js@4.4.5">chart.js@4.4.5</option>
					<option value="chart.js@4.4.4">chart.js@4.4.4</option>
					<option value="chart.js@4.4.3">chart.js@4.4.3</option>
					<option value="chart.js@4.4.2">chart.js@4.4.2</option>
					<option value="chart.js@4.4.1">chart.js@4.4.1</option>
					<option value="chart.js@4.4.0">chart.js@4.4.0</option>
					<option value="chart.js@4.3.3">chart.js@4.3.3</option>
					<option value="chart.js@4.3.2">chart.js@4.3.2</option>
					<option value="chart.js@4.3.1">chart.js@4.3.1</option>
					<option value="chart.js@4.3.0">chart.js@4.3.0</option>
					<option value="chart.js@4.2.1">chart.js@4.2.1</option>
					<option value="chart.js@4.2.0">chart.js@4.2.0</option>
					<option value="chart.js@4.1.2">chart.js@4.1.2</option>
					<option value="chart.js@4.1.1">chart.js@4.1.1</option>
					<option value="chart.js@4.1.0">chart.js@4.1.0</option>
					<option value="chart.js@4.0.1">chart.js@4.0.1</option>
					<option value="chart.js@4.0.0-release">chart.js@4.0.0-release</option>
					<option value="chart.js@4.0.0-alpha.3">chart.js@4.0.0-alpha.3</option>
					<option value="chart.js@4.0.0-alpha.2">chart.js@4.0.0-alpha.2</option>
					<option value="chart.js@3.9.1">chart.js@3.9.1</option>
					<option value="chart.js@3.9.0">chart.js@3.9.0</option>
					<option value="chart.js@3.8.2">chart.js@3.8.2</option>
					<option value="chart.js@3.8.1">chart.js@3.8.1</option>
					<option value="chart.js@3.8.0">chart.js@3.8.0</option>
					<option value="chart.js@3.7.1">chart.js@3.7.1</option>
					<option value="chart.js@3.7.0">chart.js@3.7.0</option>
					<option value="chart.js@3.6.2">chart.js@3.6.2</option>
					<option value="chart.js@3.6.1">chart.js@3.6.1</option>
					<option value="chart.js@3.6.0">chart.js@3.6.0</option>
					<option value="chart.js@3.5.1">chart.js@3.5.1</option>
					<option value="chart.js@3.5.0">chart.js@3.5.0</option>
					<option value="chart.js@3.4.1">chart.js@3.4.1</option>
					<option value="chart.js@3.4.0">chart.js@3.4.0</option>
					<option value="chart.js@3.3.2">chart.js@3.3.2</option>
					<option value="chart.js@3.3.1">chart.js@3.3.1</option>
					<option value="chart.js@3.3.0">chart.js@3.3.0</option>
					<option value="chart.js@3.2.1">chart.js@3.2.1</option>
					<option value="chart.js@3.2.0">chart.js@3.2.0</option>
					<option value="chart.js@3.1.1">chart.js@3.1.1</option>
					<option value="chart.js@3.1.0">chart.js@3.1.0</option>
					<option value="chart.js@3.0.2">chart.js@3.0.2</option>
					<option value="chart.js@3.0.1">chart.js@3.0.1</option>
					<option value="chart.js@3.0.0">chart.js@3.0.0</option>
					<option value="chart.js@3.0.0-rc.7">chart.js@3.0.0-rc.7</option>
					<option value="chart.js@3.0.0-rc.6">chart.js@3.0.0-rc.6</option>
					<option value="chart.js@3.0.0-rc.5">chart.js@3.0.0-rc.5</option>
					<option value="chart.js@3.0.0-rc.4">chart.js@3.0.0-rc.4</option>
					<option value="chart.js@3.0.0-rc.3">chart.js@3.0.0-rc.3</option>
					<option value="chart.js@3.0.0-rc.2">chart.js@3.0.0-rc.2</option>
					<option value="chart.js@3.0.0-rc">chart.js@3.0.0-rc</option>
					<option value="chart.js@3.0.0-beta.14">chart.js@3.0.0-beta.14</option>
					<option value="chart.js@3.0.0-beta.13">chart.js@3.0.0-beta.13</option>
					<option value="chart.js@3.0.0-beta.12">chart.js@3.0.0-beta.12</option>
					<option value="chart.js@3.0.0-beta.11">chart.js@3.0.0-beta.11</option>
					<option value="chart.js@3.0.0-beta.10">chart.js@3.0.0-beta.10</option>
					<option value="chart.js@3.0.0-beta.9">chart.js@3.0.0-beta.9</option>
					<option value="chart.js@3.0.0-beta.8">chart.js@3.0.0-beta.8</option>
					<option value="chart.js@3.0.0-beta.7">chart.js@3.0.0-beta.7</option>
					<option value="chart.js@3.0.0-beta.6">chart.js@3.0.0-beta.6</option>
					<option value="chart.js@3.0.0-beta.5">chart.js@3.0.0-beta.5</option>
					<option value="chart.js@3.0.0-beta.4">chart.js@3.0.0-beta.4</option>
					<option value="chart.js@3.0.0-beta.3">chart.js@3.0.0-beta.3</option>
					<option value="chart.js@3.0.0-beta.2">chart.js@3.0.0-beta.2</option>
					<option value="chart.js@3.0.0-beta">chart.js@3.0.0-beta</option>
					<option value="chart.js@3.0.0-alpha.2">chart.js@3.0.0-alpha.2</option>
					<option value="chart.js@3.0.0-alpha">chart.js@3.0.0-alpha</option>
					<option value="chart.js@2.9.4">chart.js@2.9.4</option>
					<option value="chart.js@2.9.3">chart.js@2.9.3</option>
					<option value="chart.js@2.9.2">chart.js@2.9.2</option>
					<option value="chart.js@2.9.1">chart.js@2.9.1</option>
					<option value="chart.js@2.9.0">chart.js@2.9.0</option>
					<option value="chart.js@2.8.0">chart.js@2.8.0</option>
					<option value="chart.js@2.8.0-rc.1">chart.js@2.8.0-rc.1</option>
					<option value="chart.js@2.7.3">chart.js@2.7.3</option>
					<option value="chart.js@2.7.2">chart.js@2.7.2</option>
					<option value="chart.js@2.7.1">chart.js@2.7.1</option>
					<option value="chart.js@2.7.0">chart.js@2.7.0</option>
					<option value="chart.js@2.6.0">chart.js@2.6.0</option>
					<option value="chart.js@2.5.0">chart.js@2.5.0</option>
					<option value="chart.js@2.4.0">chart.js@2.4.0</option>
					<option value="chart.js@2.3.0">chart.js@2.3.0</option>
					<option value="chart.js@2.3.0-rc.1">chart.js@2.3.0-rc.1</option>
					<option value="chart.js@2.2.2">chart.js@2.2.2</option>
					<option value="chart.js@2.2.1">chart.js@2.2.1</option>
					<option value="chart.js@2.2.0">chart.js@2.2.0</option>
					<option value="chart.js@2.2.0-rc.2">chart.js@2.2.0-rc.2</option>
					<option value="chart.js@2.2.0-rc.1">chart.js@2.2.0-rc.1</option>
					<option value="chart.js@2.1.6">chart.js@2.1.6</option>
					<option value="chart.js@2.1.5">chart.js@2.1.5</option>
					<option value="chart.js@2.1.4">chart.js@2.1.4</option>
					<option value="chart.js@2.1.3">chart.js@2.1.3</option>
					<option value="chart.js@2.1.2">chart.js@2.1.2</option>
					<option value="chart.js@2.1.1">chart.js@2.1.1</option>
					<option value="chart.js@2.1.0">chart.js@2.1.0</option>
					<option value="chart.js@2.0.2">chart.js@2.0.2</option>
					<option value="chart.js@2.0.1">chart.js@2.0.1</option>
					<option value="chart.js@2.0.0">chart.js@2.0.0</option>
					<option value="chart.js@1.1.1">chart.js@1.1.1</option>
					<option value="chart.js@1.1.0">chart.js@1.1.0</option>
					<option value="chart.js@1.0.2">chart.js@1.0.2</option>
					<option value="chart.js@1.0.1">chart.js@1.0.1</option>
					<option value="chart.js@1.0.1-beta.2">chart.js@1.0.1-beta.2</option>
				</select>
			</div>
				...
				<table>
					...
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/chart.js@4.5.1/auto/">auto</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/chart.js@4.5.1/dist/">dist</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/chart.js@4.5.1/helpers/">helpers</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/chart.js@4.5.1/LICENSE.md">LICENSE.md</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/chart.js@4.5.1/package.json">package.json</a>
						</td>
						<td class="size">4.19 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/chart.js@4.5.1/README.md">README.md</a>
						</td>
			...
			<div class="landing">
				<p class="left">Free Open Source CDN for <strong>chart.js</strong></p>

				<p class="right">
					Looking for a nice landing page for your package?
					<a href="https://www.jsdelivr.com/package/npm/chart.js">https://www.jsdelivr.com/package/npm/chart.js</a>
				</p>
			</div>
		</div>
		...
		<script>
			...
			[].slice.call(versions.querySelectorAll('option')).forEach(function(option) {
				if (option.value === 'chart.js@4.5.1') {
