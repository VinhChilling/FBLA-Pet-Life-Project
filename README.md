...
- Performance charts and grades (charts.js was utilized to display chart graphics)
...
- HTML:
    - Allows us to structure our website with ease.
    - Free and open source
    - Universally accepted 
    - Gives us easy formatting and optimal editability over time
- CSS: 
    - CSS allows us to style the front end of our web app.
    - It is simple yet powerful as it grants us major control over the visual aspect and adds liveliness to the website
- JavaScript:
    - Allows us to implement the logic that dictates the website
    - Enables us to create functions and code to implement and manipulate the mechanics of the game
- Python:
    - Easy data synergy and adaptibility
    - Effective backend building and easy frontend integration for the future.
